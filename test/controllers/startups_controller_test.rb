...
class StartupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create startup" do
    assert_difference("Startup.count") do
      post startups_url, params: { startup: { country: @startup.country, favorite: @startup.favorite, homepage_url: @startup.homepage_url, industry: @startup.industry, name: @startup.name, total_funding: @startup.total_funding } }
    end
  ...
  test "should update startup" do
    patch startup_url(@startup), params: { startup: { country: @startup.country, favorite: @startup.favorite, homepage_url: @startup.homepage_url, industry: @startup.industry, name: @startup.name, total_funding: @startup.total_funding } }
